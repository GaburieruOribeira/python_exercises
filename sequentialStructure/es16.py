...
# The program must request the size in square meters of the area to be painted.
...
# Inform the user of the quantity of paint cans to be purchased and the total price.
